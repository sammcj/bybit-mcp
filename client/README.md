...
bybit-mcp-client chat qwen3-30b-a3b-ud-nothink-128k:q4_k_xl --system "You are a helpful assistant"
```
...
const response = await client.chat('qwen3-30b-a3b-ud-nothink-128k:q4_k_xl', messages);
